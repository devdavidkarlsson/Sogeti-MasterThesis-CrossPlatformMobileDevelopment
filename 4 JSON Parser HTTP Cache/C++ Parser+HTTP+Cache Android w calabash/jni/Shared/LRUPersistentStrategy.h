//LRUPersistentStrategy.h
//Nothing changed in comparison to LRUStrategy.h


#ifndef __LRUPersistentStrategy__
#define __LRUPersistentStrategy__
...
namespace Poco {
    ...
    public:
        ...
        {
            // LRU: in case of a hit, move to begin
            IndexIterator it = _keyIndex.find(key);
...
#endif /* defined(__LRUPersistentStrategy__) */
